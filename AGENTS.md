...
This project is indexed by GitNexus as **maplibre-style-tools** (4254 symbols, 11222 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
