...
import type { ImageOptionsInput, RuntimeGeoJsonSourceDiff, RuntimeImageLoader } from '../adapters/maplibre/index.js';
...
export type AiStyleToolResult<TData> =
...
export interface MapLibreAiTool<TInput, TData> { execute(input: TInput): Promise<AiStyleToolResult<TData>>; }
